...
VALUES ('Pallina Butterfly', 'una pallina di qualità', 5, 50, 0, 'racchette',
        '/Torre_Durante_pj_war_exploded/images/imageNA.png'),
       ('Racchetta Stiga', 'racchetta professionale', 45, 10, 5, 'racchette',
        '/Torre_Durante_pj_war_exploded/images/imageNA.png'),
       ('Borsa da tennis', 'borsa capiente e resistente', 60, 7, 10, 'racchette',
        '/Torre_Durante_pj_war_exploded/images/imageNA.png'),
       ('Set di palline', 'set di 6 palline', 12, 30, 0, 'racchette',
        '/Torre_Durante_pj_war_exploded/images/imageNA.png'),
       ('Tavolo da ping pong', 'tavolo di alta qualità', 300, 5, 15, 'racchette',
        '/Torre_Durante_pj_war_exploded/images/imageNA.png');
